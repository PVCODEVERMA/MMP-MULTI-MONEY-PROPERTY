  ...
  const features = [
    {
      ...
      description: "City, locality and pin-code filters for exact audience reach"
    },
    {
      icon: Navigation,
      title: "Project-Level Accuracy",
      description: "Project tags for precision delivery and better conversion rates"
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: "Run hyper-local campaigns matching live inventory availability"
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              ...
              <p className="mt-4 text-lg text-[#154956]/80 max-w-2xl leading-relaxed">
                Run micro-campaigns at city, sector or project level with pinpoint accuracy. 
                Match live inventory and maximize your ROI with our advanced geo-targeting platform.
              </p>
            ...
            <div className="relative">
              <div className=" rounded-3xl p-8 md:p-12 text-white ">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-[#154056]">Precision Metrics</h3>
                  <div className="grid grid-cols-2 gap-4">
                    {stats.map((stat, index) => (
                      <div key={index} className="text-center">
                        <div className="text-2xl font-bold text-[#ff9c00]">{stat.value}</div>
                        <div className="text-sm opacity-90 text-[#ff9c00]">{stat.label}</div>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-[#154956]/80 max-w-3xl mx-auto">
            Leverage our sophisticated geo-targeting capabilities to reach your ideal audience 
            ...
            {[
              {
                ...
                description: "Precisely target specific cities and localities with advanced filtering options",
                benefits: ["Radius targeting", "Multiple location selection", "Real-time coverage maps"]
              },
              {
                title: "Pin-Code Precision",
                description: "Target down to individual pin-codes for hyper-local campaign delivery",
                benefits: ["Pin-code validation", "Coverage analysis", "Delivery optimization"]
              },
              {
                title: "Project Tag Integration",
                description: "Seamlessly integrate project tags for context-aware campaign delivery",
                benefits: ["Auto-tagging", "Project matching", "Inventory synchronization"]
              },
              {
                title: "Smart Auto-Enrichment",
                description: "Automatically enrich targeting data from pin-codes (roadmap feature)",
                benefits: ["Data enhancement", "Smart suggestions", "Performance insights"]
              }
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">
                      {capability.benefits.map((benefit, idx) => (
                        <li key={idx} className="text-sm  text-[#154956]/60 flex items-center gap-2">
        ...
        <div className="text-center mt-16 bg-gradient-to-r from-[#154956] to-[#FF9C00] rounded-3xl p-8 md:p-12 text-white shadow-2xl">
          ...
          <p className="text-white/90 max-w-2xl mx-auto mb-6">
            Join thousands of marketers who are already using our advanced geo-targeting 
            platform to drive better results and higher conversions.
          </p>
