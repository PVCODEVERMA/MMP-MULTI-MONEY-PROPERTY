      ...
      <section className="py-12 px-4 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-bold text-[#164058]">
            Exclusive Owner <span className="text-[#FF9C00]">Properties</span>
          </h2>
          <a
            href="#"
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center text-sm text-[#164058] line-clamp-2">
                    ...
                    <span className="flex gap-2"><MapPinIcon className="h-4 w-4 mt-0.5 text-[#FF9C00]" /> {properties[currentSlide].location}</span>
                  </div>
                  <div className="flex justify-between items-center mt-3 text-xs text-gray-500">
                    <span>By {properties[currentSlide].postedBy}</span>
                    <span>{properties[currentSlide].postedTime}</span>
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
            ...
            {Array.from({ length: Math.min(totalSlides, 5) }).map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full ${
                  index === currentSlide ? "bg-[#FF9C00]" : "bg-gray-300"
                }`}
              />
            ))}
          </div>
        ...
        {/* 💻 Desktop Slider (4 cards per page) */}
        <div className="hidden sm:block">
          <div className="relative">
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center text-sm text-[#164058] line-clamp-2">
                        ...
                        <span className=" flex gap-3"> <MapPinIcon className="h-4 w-4 mt-0.5 text-[#FF9C00]" />{property.location}</span>
                      </div>
                      <div className="flex justify-between items-center mt-3 text-xs text-gray-500">
            ...
            <button
              ...
              className="absolute top-1/2 -left-10 transform -translate-y-1/2 bg-[#FF9C00] text-white hover:text-[#154058] shadow rounded-full cursor-pointer p-2 disabled:opacity-50"
            >
              ◀
            </button>
            <button
