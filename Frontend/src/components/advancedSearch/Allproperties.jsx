  ...
  const filteredProperties = useMemo(() => {
    ...
    if (q.propertyType) {
      result = result.filter(property => 
        ...
        (property.bhk && property.bhk.toLowerCase().includes(q.propertyType.toLowerCase()))
      );
    }
    ...
    if (q.bhk) {
      result = result.filter(property => 
        property.bhk && property.bhk.toLowerCase().includes(q.bhk.toLowerCase())
      );
    }
    ...
    if (sort === "latest") {
      ...
      result.sort((a, b) => {
        const priceA = parseFloat(a.price.replace(/[^0-9.]/g, '')) * (a.price.includes('Cr') ? 100 : 1);
        const priceB = parseFloat(b.price.replace(/[^0-9.]/g, '')) * (b.price.includes('Cr') ? 100 : 1);
    ...
    for (let i = startPage; i <= endPage; i++) {
      buttons.push(
        <button
          key={i}
          onClick={() => setPage(i)}
          className={`mx-1 px-3 py-1 rounded text-sm font-medium transition-colors ${
            page === i
              ? "bg-orange-500 text-white shadow-md"
              : "bg-white text-gray-700 border border-gray-200 hover:bg-gray-50"
          }`}
  ...
  return (
    ...
    <section className=" bg-[#f7f7f7] mt-4">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col lg:flex-row gap-3 lg:gap-4">
          ...
          <div className="w-full lg:flex-1">
            <LocationSelector
              ...
              onLocationChange={(loc) => setQ((s) => ({ ...s, location: loc }))}
              placeholder="Search location leads..."
            />
          </div>

          {/* Property type - hidden on mobile */}
          <div className="relative w-full lg:w-48 hidden lg:block">
            <HomeIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-orange-500" />
            <select
              value={q.propertyType}
              onChange={(e) =>
                setQ((s) => ({ ...s, propertyType: e.target.value }))
              }
              className="w-full pl-12 pr-3 py-3 border border-gray-300 rounded-xl bg-white cursor-pointer focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
            >
          ...
          <div className="relative w-full lg:w-48 hidden lg:block">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-orange-500">
              ₹
            </span>
            <select
              value={q.budget}
              onChange={(e) => setQ((s) => ({ ...s, budget: e.target.value }))}
              className="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl bg-white cursor-pointer focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
            >
          ...
          <div className="relative w-full lg:w-64 hidden lg:block">
            <input
              ...
              className="w-full pr-12 pl-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
            />
            <MagnifyingGlassIcon 
            
            className="absolute right-3 top-1/2 -translate-y-1/2 w-6 h-6 text-[#FF9c00] font-bold" />
          </div>
            ...
            >
              <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <button
                  ...
                  className="absolute top-4 right-4 lg:hidden p-1 rounded-full bg-gray-200 hover:bg-gray-300 transition-colors"
                >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg cursor-pointer focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
                  >
              ...
              <div className="max-w-7xl mx-auto px-4 pb-4 text-right">
                <button
                  ...
                  className="text-sm text-gray-500 hover:text-orange-500 transition-colors cursor-pointer py-2 "
                >
                  Clear filters
                </button>
              </div>
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4 mb-6">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors cursor-pointer"
            >
        ...
        {filteredProperties.length > 0 ? (
            ...
            {paginatedData.map((card) => (
              ...
              >
                <div className="relative">
                  ...
                  />
                  {/* badges */}
                  <span className="absolute top-2 left-2 px-2 py-1 text-xs font-semibold rounded text-white bg-orange-500">
                    {card.tag}
                  </span>
          ...
          <div className="text-center py-12">
            ...
            <button
              ...
              className="mt-4 px-6 py-2 bg-[#FF9C00] text-white rounded-lg hover:bg-orange-600 transition-colors cursor-pointer"
            >
              Clear all filters
            </button>
          </div>
      ...
      <button
        ...
        className="px-4 py-2 rounded-lg border  bg-white text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer"
      >
        Next
      </button>
    </div>
