    ...
    <div className="min-h-screen bg-[#f7f7f7] py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3 property-hero-title">
            List Your Property <span className="text-orange-500">Free</span>
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
          <div className="bg-orange-500 py-4 px-6 flex justify-center">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-8">
            ...
            <Section title="Contact Information">
              <div className="space-y-6">
                <PhoneField
                  ...
                  inputStyle={{ width: "100%", color: "#111827", "::placeholder": { color: "#9CA3AF" } }}
                />
                <PhoneField
            ...
            <Section title="Property Images">
              <div className="space-y-4">
                <div
                  className="border-2 border-dashed border-orange-300 rounded-xl p-8 text-center cursor-pointer transition-all hover:border-orange-400 hover:bg-orange-50"
                  onClick={() => fileInputRef.current?.click()}
                >
                  <PhotoIcon className="h-12 w-12 mx-auto text-orange-400 mb-3" />
                      ...
                      {images.map((img, i) => (
                        <div key={img.url} className="relative group">
                          <motion.img
                            ...
                            className="w-full h-24 object-cover rounded-lg border-2 border-gray-200 cursor-pointer transition-all group-hover:border-orange-400 group-hover:shadow-md"
            ...
            <div className="pt-6 border-t border-gray-200">
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-orange-500 to-orange-600  text-white font-semibold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all disabled:opacity-50 cursor-pointer"
              >
                {isSubmitting ? (
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-6 w-6 border-b-2 bg-[#154056] border-white mr-3"></div>
                    Posting Property...
                  </div>
                ) : (
                  `Post Property ${formData.purpose === "rent" ? "for Rent" : "for Sale"} - FREE`
                )}
              </button>
              <p className="text-center text-gray-500 text-sm mt-3">
                By posting your property, you agree to MMP’s Terms & Conditions.
              </p>
            </div>
          </form>
        </div>
        ...
        {modalIdx !== null && images[modalIdx] && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => setModalIdx(null)}
                className="absolute top-4 right-4 bg-orange-500 p-3 rounded-full hover:bg-[#154056] transition-colors cursor-pointer"
              >
...
function Select({ label, options, ...props }) {
  return (
    <div>
      ...
      <select
        {...props}
        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors cursor-pointer"
      >
...
function Textarea({ label, ...props }) {
  return (
    <div>
      ...
      <textarea
        {...props}
        className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors resize-vertical"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <PhoneInput
        ...
        value={value}
        onChange={onChange}
        inputClassName="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
...
function NavButton({ children, onClick, pos }) {
  return (
    <button
      onClick={onClick}
      className={`absolute ${pos === 'left' ? 'left-4' : 'right-4'} top-1/2 -translate-y-1/2 bg-orange-500 p-4 rounded-full hover:bg-orange-600 transition-colors`}
    >
      {children}
    </button>
  );
