...
const SuperAdminHeader = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const notifications = [
    ...
    },
    {
      id: 3,
      title: 'System Update',
      message: 'New features deployed to production',
      time: '1h ago',
      type: 'info',
      unread: false
    }
    ...
    <header className="bg-white shadow-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 relative z-10">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            type="text"
            placeholder="Search users, companies, system..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="block w-96 pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-red-500 focus:border-red-500"
          />
        </div>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="hidden lg:flex items-center space-x-6 text-sm text-gray-600">
          ...
          <div>
            <span className="font-semibold text-gray-900">1,247</span> Users
          </div>
          <div>
            <span className="font-semibold text-gray-900">85</span> Companies
          </div>
          <div>
            <span className="font-semibold text-gray-900">₹8.4M</span> Revenue
          </div>
        </div>
                ...
                {notifications.map((notification) => (
                  <div
                    ...
                    className={`px-4 py-3 hover:bg-gray-50 cursor-pointer ${
                      notification.unread ? 'bg-red-50 border-l-4 border-l-red-500' : ''
                    }`}
                  >
